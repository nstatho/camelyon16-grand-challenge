...
# CAMELYON_PROCESSED_PATCHES_TRAIN = '/home/nikolas/pro/Arjun/Study/Thesis/CAMELYON16/data/CAMELYON16/Processed/' \
...
CAMELYON_PROCESSED_PATCHES_TRAIN = '/media/bulk_storage/camelyon16/Processed/patch-based-classification/raw-data/train/'
CAMELYON_PROCESSED_PATCHES_TRAIN_NEGATIVE = CAMELYON_PROCESSED_PATCHES_TRAIN + 'label-0/'
CAMELYON_PROCESSED_PATCHES_TRAIN_POSITIVE = CAMELYON_PROCESSED_PATCHES_TRAIN + 'label-1/'

CAMELYON_PROCESSED_PATCHES_VALIDATION = '/media/bulk_storage/camelyon16/Processed/patch-based-classification/raw-data/validation/'
CAMELYON_PROCESSED_PATCHES_VALIDATION_NEGATIVE = CAMELYON_PROCESSED_PATCHES_VALIDATION + 'label-0/'
CAMELYON_PROCESSED_PATCHES_VALIDATION_POSITIVE = CAMELYON_PROCESSED_PATCHES_VALIDATION + 'label-1/'

OUTPUT_DIR = '/media/bulk_storage/camelyon16/Processed/patch-based-classification/tf-records/'
